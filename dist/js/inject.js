...
const send = (props, tabId) => {
    ...
    const service = {
        window: () => {
            try {
                window.postMessage(Object.assign(Object.assign({}, props), { extensionName: "MOKKU" }), "*");
            }
            catch (error) {
        ...
        runtime: () => {
            try {
                chrome.runtime.sendMessage(Object.assign(Object.assign({}, props), { extensionName: "MOKKU" }));
            }
            catch (error) {
